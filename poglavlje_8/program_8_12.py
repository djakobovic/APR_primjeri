...
def newton(f, df, x0 = [0,0], maxiter = 99, eps = 0.000001, step = 0, ax = None, korak = 0):
    '''
    f: funkcija cilja
    df: prva i druga derivacija funkcije cilja
    x0: pocetna tocka
...
if __name__ == '__main__':
    ...
    x = newton(f, df, x0 = [-1, -1], maxiter = 20, eps = 0.00001, step = 1., ax = ax)
